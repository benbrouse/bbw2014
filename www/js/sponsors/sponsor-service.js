(function() {
    ...
    angular
        .module('bbw.sponsor-service', ['ngResource', 'core-services', 'jmdobry.angular-cache'])
        .factory('SponsorsService', SponsorsService);

    SponsorsService.$inject = ['$q', '$timeout', '$log', '$resource', '$angularCacheFactory', 'AppSettings'];

    function SponsorsService($q, $timeout, $log, $resource, $angularCacheFactory, AppSettings) {
